...
* The [`$id`](http://json-schema.org/latest/json-schema-core.html#section.8.2.1) keyword.
* The [`$schema`](http://json-schema.org/latest/json-schema-core.html#section.8.1.1) keyword.
* The [`type`](http://json-schema.org/latest/json-schema-validation.html#section-6.1.1) validation keyword.
* The [`required`](http://json-schema.org/latest/json-schema-validation.html#section-6.5.3) validation keyword.
...
* The [`patternProperties`](http://json-schema.org/latest/json-schema-core.html#section-10.3.2.2) validation keyword.
  * This matches other property names via a regular expression. Note: it does not match `/`.
  * The `^(/[^/]+)+$` key is empty now; We will fill it out later.
* The [`additionalProperties`](http://json-schema.org/latest/json-schema-core.html#section-10.3.2.3) validation keyword.
...
* The [`description`](http://json-schema.org/latest/json-schema-validation.html#section-9.1) annotation keyword.
* The [`oneOf`](http://json-schema.org/latest/json-schema-core.html#section-10.2.1.3) keyword.
* The [`$ref`](http://json-schema.org/latest/json-schema-core.html#section.8.2.3.1) keyword.
  * In this case, all references used are local to the schema using a relative fragment URI (`#/...`).
* The [`$defs`](http://json-schema.org/latest/json-schema-core.html#section.8.2.4) keyword.
...
* Our `fstype` key uses the [`enum`](http://json-schema.org/latest/json-schema-validation.html#section-6.1.2) validation keyword.
* Our `options` key uses the following:
  * The `type` validation keyword (see above).
  * The [`minItems`](http://json-schema.org/latest/json-schema-validation.html#section-6.4.2) validation keyword.
  * The [`items`](http://json-schema.org/latest/json-schema-core.html#section-10.3.1.2) validation keyword.
  * The [`uniqueItems`](http://json-schema.org/latest/json-schema-validation.html#rfc.section.6.4.3) validation keyword.
...
* The [`pattern`](http://json-schema.org/latest/json-schema-validation.html#section-6.3.3) validation keyword notes the `device` key must be an absolute path starting with */dev*.
...
* The [`format`](http://json-schema.org/latest/json-schema-validation.html#section-7) annotation and assertion keyword.
...
* The [`minimum`](http://json-schema.org/latest/json-schema-validation.html#section-6.2.4) validation keyword.
* The [`maximum`](http://json-schema.org/latest/json-schema-validation.html#section-6.2.2) validation keword.
